...
export const my: DeepPartial<Labels> = {
  ...
  dash: {
    ...
    moneyIn: "ရရှိငွေ",
    moneyOut: "ထွက်ငွေ",
    cashReceivedToday: "ငွေသားရရှိ (ဒီနေ့)",
    expectedCashToday: "လက်ကျန်ငွေ (ဒီနေ့)",
    moneyReceivedToday: "ရရှိငွေ (ဒီနေ့)",
    itemsSold: "ရောင်းရသော ပစ္စည်းများ",
    itemReceipts: "ဤပစ္စည်းပါသော ဘောင်ချာများ",
  ...
  movements: {
    title: "စတော့ လှုပ်ရှားမှု",
    allItems: "ပစ္စည်းအားလုံး",
    allLocations: "နေရာအားလုံး",
    balance: "လက်ကျန်",
    empty: "လှုပ်ရှားမှု မရှိပါ",
    date: "ရက်စွဲ",
    change: "ပြောင်းလဲ",
    locTailor: "ချုပ်ဆရာ",
    pickItemForBalance: "လက်ကျန် ကြည့်ရန် ပစ္စည်း တစ်ခု + နေရာ ရွေးပါ",
    kinds: {
      OPENING_STOCK: "အစ စတော့",
      RECEIPT: "အလိပ် ဝင်",
      CUT: "အလိပ်ဖြတ်",
      TAILOR_SEND: "ချုပ်ပို့",
      TAILOR_RETURN: "ချုပ်ပြန်",
      WASH: "လျှော်ဖွပ်",
      TRANSFER: "ဆိုင်ပို့",
      SALE: "အရောင်း",
      RETURN_FROM_CUSTOMER: "ဖောက်သည် ပြန်အမ်း",
      ADJUSTMENT: "စတော့ရေတွက်",
      LOSS: "လျော့",
  ...
  sell: {
    ...
    review: "စစ်ဆေးမယ်",
    paidNow: "ယခုရရှိငွေ",
    paymentMethod: "ငွေပေးနည်း",
    note: "မှတ်ချက်",
    notePlaceholder: "ဥပမာ — မနက်ဖြန်မှလာယူမည်၊ အိမ်အရောက်ပို့…",
  ...
  tailorWork: {
    ...
    sendPieces: "ချုပ်ရန် ပစ္စည်း",
    materials: "သုံးသော ပစ္စည်း",
    materialsHint: "စတော့မှ နုတ်သည် (ဥပမာ - အထက်ဆင်)",
    addMaterial: "ပစ္စည်း ထပ်ထည့်",
  ...
  customerDetail: {
    ...
    delete: "ဖောက်သည် ဖျက်မယ်",
    deleteConfirm:
      "ဤဖောက်သည်ကို ဖျက်မလား? ၎င်းတို့၏ ကျန်ရှိနေသော အကြွေးကို ရှင်းလင်းပြီး စာရင်းအားလုံးမှ ဖယ်ရှားသွားမည်။ ယခင် အရောင်းမှတ်တမ်းများ ကျန်ရှိနေပါမည်။",
    merge: "ထပ်နေသူများ ပေါင်းမယ်",
    mergeTitle: "ထပ်နေသော ဖောက်သည်များကို ဤတစ်ဦးထဲ ပေါင်းမယ်",
    mergeHelp:
      "ထပ်နေသော မှတ်တမ်းများကို ရွေးပါ။ ၎င်းတို့၏ အရောင်း၊ ပေးငွေနှင့် ပြန်အမ်းမှုများ ဤနေရာသို့ ရွှေ့ပြီး ဖျက်မည် — ဘာမှ မပျောက်ပါ။",
    mergeSearch: "ဖောက်သည် နာမည်ဖြင့် ရှာမယ်…",
    mergeEmpty: "ကိုက်ညီသော အခြားဖောက်သည် မရှိပါ",
    mergeAction: "ရွေးထားသူများ ပေါင်းမယ်",
    mergeConfirm:
      "ရွေးထားသော ဖောက်သည်များ၏ မှတ်တမ်းအားလုံးကို ဤတစ်ဦးထဲ ရွှေ့ပြီး ၎င်းတို့ကို ဖျက်မလား? ပြန်ဖျက်၍မရပါ။",
    similarExists: "ဆင်တူ ဖောက်သည် ရှိနှင့်ပြီး — အသစ်မလုပ်ဘဲ ၎င်းကို သုံးပါ:",
  },
  ...
  settings: {
    ...
    shopName: "ဆိုင်အမည်",
    address: "လိပ်စာ",
    addressHint: "လိပ်စာရှည်လျှင် နောက်တစ်ကြောင်းသို့ ဆက်နိုင်သည်",
    phone: "ဖုန်း",
    phoneHint: "နံပါတ် ၄ ခုအထိ — အကွက်တစ်ခုလျှင် တစ်ခု",
    social: "ဆိုရှယ်မီဒီယာ",
    socialHint: "၂ ခုအထိ — အကွက်တစ်ခုလျှင် တစ်ခု",
  ...
  admin: {
    ...
    stockMovements: "စတော့ လှုပ်ရှားမှု",
    ...
    order: {
      ...
      yards: "ကိုက်",
      pricePerYard: "တစ်ကိုက်စျေး",
      orderDate: "မှာသည့်ရက်",
      receiptDate: "လက်ခံသည့်ရက်",
      paymentDate: "ပေးသည့်ရက်",
  ...
  salesAdmin: {
    ...
    confirm: "ပယ်ဖျက်မယ်",
    walkIn: "လမ်းသွား",
    editPrices: "အရောင်း ပြင်မယ်",
    editPricesHelp:
      "ပစ္စည်း၊ အရေအတွက်၊ ဈေးနှုန်း၊ လျှော့စျေး သို့မဟုတ် ပေးငွေပမာဏကို ပြင်ပါ။ ပစ္စည်းလက်ကျန်နှင့် ဖောက်သည်အကြွေး အလိုအလျောက် ပြောင်းပါမည်။",
    credit: "ကြိုတင်ပေး",
