...
export const my: DeepPartial<Labels> = {
  ...
  sell: {
    ...
    oneTimeBuyer: "တစ်ကြိမ်တည်း (လက်ငင်းရောင်း)",
    ...
    freeNotePlaceholder: "အကြောင်းပြချက် (အလကား / အစားထိုး)",
