...
export const my: DeepPartial<Labels> = {
  ...
  salesAdmin: {
    ...
    confirm: "ပယ်ဖျက်မယ်",
    walkIn: "လမ်းသွား",
    editPrices: "ဈေးနှုန်း ပြင်မယ်",
    editPricesHelp:
      "မှားရိုက်ထားသော ဈေးနှုန်းကို ပြင်ပါ။ အရေအတွက်နှင့် ပစ္စည်းလက်ကျန် မပြောင်းပါ။ စုစုပေါင်းနှင့် ဖောက်သည်အကြွေး အလိုအလျောက် ပြောင်းပါမည်။",
    credit: "ကြိုတင်ပေး",
  },
