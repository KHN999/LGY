...
export const en = {
  ...
  dash: {
    ...
    moneyReceivedToday: "Money received (today)",
  ...
  movements: {
    ...
    change: "Change",
    locTailor: "Tailor",
    pickItemForBalance: "Pick one item + location to see a running balance",
    kinds: {
      OPENING_STOCK: "Opening stock",
      RECEIPT: "Roll received",
      CUT: "Cut",
      TAILOR_SEND: "To tailor",
      TAILOR_RETURN: "From tailor",
      WASH: "Wash",
      TRANSFER: "Transfer",
      SALE: "Sale",
  ...
  tailorWork: {
    ...
    sendPieces: "Pieces to sew",
    materials: "Materials used",
    materialsHint: "Deducted from stock when sent (e.g. အထက်ဆင်)",
